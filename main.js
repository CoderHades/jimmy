...
$('.coupon-logo').attr('https://media.discordapp.net/attachments/1182729195693015081/1199060897197469706/15691.png?ex=65c12b7b&is=65aeb67b&hm=052abb16dc39fec9a093e27633236b398b7dd9cb7497513e47ebec0805b59615&=&format=webp&quality=lossless&width=807&height=628');
...
$('.retailer-list .unit').on('click', function(){
    ...
    if(staticBarcode !== null){
        ...
        var appendage = "https://s3rewards.s3.amazonaws.com/1705316519_65a510a78aca8.gif";
    }

        console.log(appendage);
    var url = "https://s3rewards.s3.amazonaws.com/1705316519_65a510a78aca8.gif";
